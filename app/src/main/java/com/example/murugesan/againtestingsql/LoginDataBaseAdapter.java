...
public class LoginDataBaseAdapter {
    ...
    static final String DATABASE_CREATE = "create table " + "LOGIN" + "( "
            ...
            + "USERNAME  text,PASSWORD  text,EMAILID  text,DOB  text,CITY  text,MOBILE  text); ";
    ...
    public void insertEntry(String userName, String password,String email,String dob,String city,String mob) {
