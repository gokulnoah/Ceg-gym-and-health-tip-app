...
public class HomeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignIn = (ImageButton) findViewById(R.id.buttonSignIN);
        btnSignUp = (ImageButton) findViewById(R.id.buttonSignUP);
            ...
            public void onClick(View v) {
                ...
                if (password.equals(storedPassword)) {
                    Toast.makeText(HomeActivity.this,
                            ...
                            .show();
                    dialog.dismiss();
                    Intent main = new Intent(HomeActivity.this, Welcome2.class);
                    startActivity(main);
                } else {
                    Toast.makeText(HomeActivity.this,
